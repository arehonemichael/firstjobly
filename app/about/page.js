  ...
  return (
    <main className="max-w-3xl mx-auto px-4 py-12">
      ...
      <p className="text-gray-700 mt-4 leading-relaxed">
        Whether you're just getting started or switching fields, FirstJobly helps you find your first break.
        Browse verified jobs, stay updated with our blog, and let us help you grow.
      </p>
    </main>
  );
}
